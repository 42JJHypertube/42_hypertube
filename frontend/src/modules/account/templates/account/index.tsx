  ...
  switch (currentView) {
    case LoginViewEnum.SIGN_IN:
      return {
        ...
        content: "모든 영화인들을 위한 HyperTube 회원 커뮤니티에 오신 것을 환영합니다. 로그인을 완료하고 모험을 시작하세요."
      }
    case LoginViewEnum.REGISTER:
      return {
        title: "Hyper Tube에 가입하세요",
        content: "모든 영화인들을 위한 HyperTube 회원 커뮤니티에 오신 것을 환영합니다. 가입을 완료하고 모험을 시작하세요."
      }
    case LoginViewEnum.FIND_PW:
      return {
        title: "비밀번호를 잊으셨나요?",
...
function AccountTemplate() {
  ...
  return (
    <div className={styles.container}>
      <div className={isAnimating ? `${styles.information} ${styles.infoAni}` : styles.information}>
